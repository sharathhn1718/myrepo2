    ...
    stages {
        ...
        stage('Test') {
            steps {
                ...
                echo 'Test stage succeeded (sharu)'
            }
        }
        ...
        stage('Deploy') {
            steps {
                ...
                echo 'Deploy stage succeeded (sharu)'
            }
        }
    }
